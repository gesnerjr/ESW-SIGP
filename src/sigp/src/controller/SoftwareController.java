...
public class SoftwareController implements IHeaderController {
	...
	public SoftwareController(Result result, Validator validator,
			SoftwareDao sdao, PublicacaoDao pubdao, ProjetoDao projdao,
			LinhaDePesquisaDao ldao, MembroDao cdao, NoticiaDao ndao) {
		this.result = result;
